    ...
    <script>
        $(document).ready(function() {
            ...
            table.DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.setting.group-kategori-asset.datatable') }}",
                columns: [{
                        data: "DT_RowIndex",
                        class: "text-center",
                        orderable: false,
        ...
        const edit = (button) => {
            ...
            $.ajax({
                ...
                success: function(response) {
                    const modal = $('.modalEditGroupKategoriAsset');
                    const form = modal.find('form');
                    form.attr('action', url_update);
                    form.find('input[name=kode_group]').val(response.data.kode_group);
                    form.find('input[name=nama_group]').val(response.data.nama_group);
                    modal.modal('show');
                }
            })
        }
...
@section('main-content')
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <button type="button" onclick="openModalByClass('modalCreateGroupKategoriAsset')"
    ...
    @include('pages.admin.settings.group-kategori-asset._modal_edit')
@endsection
