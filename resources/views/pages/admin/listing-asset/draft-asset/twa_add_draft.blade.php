            ...
            <div class="row">
                <div class="col-12" id="colTable">
                    ...
                    <form class="kt-form kt-form--fit kt-form--label-right"
                        action="{{ route('admin.listing-asset.store.twa') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="kt-scroll ps ps--active-y" data-scroll="true" style="overflow: hidden; height: 70vh;">
                                <div class="row">
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input value="{{ old('kode_asset')}}" type="text" class="form-control" name="kode_asset">
                                        @error('kode_asset')
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input value="{{ old('deskripsi')}}" type="text" class="form-control" name="deskripsi">
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input value="{{ old('no_seri')}}" type="text" class="form-control" name="no_seri">
                                        @error('no_seri')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <select name="id_group_asset" class="form-control" id="groupAssetCreate">
                                            ...
                                            <option value="{{$row->id}}" {{ old('id_group_asset') == $row->id ? 'selected' : '' }}>
                                                {{$row->nama_group}}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input value="{{ old('no_urut')}}" type="text" class="form-control" name="no_urut">
                                        @error('no_urut')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input value="{{ old('tanggal_perolehan') }}" type="date" class="form-control datepickerCreate" name="tanggal_perolehan">
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input value="{{ old('nilai_perolehan') }}" type="number" class="form-control" name="nilai_perolehan">
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <input type="date" class="form-control datepickerCreate"
                                            name="tanggal_pelunasan" value="{{ old('tanggal_pelunasan') }}">
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <select name="id_vendor" class="form-control" id="vendorAssetCreate">
                                            ...
                                            <option value="{{$row->id}}" {{ old('id_vendor') == $row->id ? 'selected' : '' }}>{{$row->nama_vendor}}</option>
                                            @endforeach
                                        </select>
                                        @error('id_vendor')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <option value="" disabled selected>Pilih Lokasi</option>
                                            ...
                                            <option value="<?php echo $row["id"] ?>" {{ old('id_lokasi') == $row['id'] ? 'selected' : '' }}><?php echo $row["text"] ?></option>
                                            @endforeach
                                        </select>
                                        @error('id_lokasi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="form-group col-md-4 col-6">
                                        ...
                                        <select class="form-control" onchange="jenisAssetChange(this)" name="jenis_penerimaan">
                                            <option value="" {{ old('jenis_penerimaan') == '' ? 'selected' : '' }}>Pilih Jenis Perolehan</option>
                                            <option data-asset-lama="0" value="PO" {{ old('jenis_penerimaan') == 'PO' ? 'selected' : '' }}>PO</option>
                                            <option data-asset-lama="0" value="Hibah Eksternal" {{ old('jenis_penerimaan') == 'Hibah Eksternal' ? 'selected' : '' }}>Hibah Eksternal</option>
                                            <option data-asset-lama="0" value="Hibah Penelitian" {{ old('jenis_penerimaan') == 'Hibah Penelitian' ? 'selected' : '' }}>Hibah Penelitian</option>
                                            <option data-asset-lama="0" value="Hibah Perorangan" {{ old('jenis_penerimaan') == 'Hibah Perorangan' ? 'selected' : '' }}>Hibah Perorangan</option>
                                            <option data-asset-lama="1" value="Dari Asset Lama" {{ old('jenis_penerimaan') == 'Dari Asset Lama' ? 'selected' : '' }}>Dari Asset Lama</option>
                                            <option data-asset-lama="0" value="UMK" {{ old('jenis_penerimaan') == 'UMK' ? 'selected' : '' }}>UMK</option>
                                            <option data-asset-lama="0" value="CC" {{ old('jenis_penerimaan') == 'CC' ? 'selected' : '' }}>CC</option>
                                            <option data-asset-lama="0" value="Reimburse" {{ old('jenis_penerimaan') == 'Reimburse' ? 'selected' : '' }}>Reimburse</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status_memorandum" class="form-control mr-3" id=""
                                                ...
                                                <option value="" {{ old('status_memorandum') == '' ? 'selected' : '' }}>Pilih Asal Memorandum</option>
                                                <option value="tidak-ada" {{ old('status_memorandum') == 'tidak-ada' ? 'selected' : '' }}>Tidak Ada Memorandum</option>
                                                <option value="andin" {{ old('status_memorandum') == 'andin' ? 'selected' : '' }}>Dari ANDIN</option>
                                                <option value="manual" {{ old('status_memorandum') == 'manual' ? 'selected' : '' }}>Input Manual</option>
                                            </select>
                                        ...
                                        <div class="form-group d-none" id="memo_manual">
                                            ...
                                            <input value="{{ old('no_memo_surat_manual')}}" type="text" class="form-control" name="no_memo_surat_manual">
                                        </div>
                                        <div class="form-group" id="twa_nomor_po">
                                            <label for="">Nomor PO</label>
                                            <input value="{{ old('no_po')}}" type="text" class="form-control" name="no_po">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Nomor SP3</label>
                                            <input value="{{ old('no_sp3')}}" type="text" class="form-control" name="no_sp3">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-6">
                                        <div class="form-group">
                                            <label for="">Cost Center</label>
                                            <input value="{{ old('cost_center')}}" type="text" class="form-control" name="cost_center">
                                        </div>
                                        {{-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <select name="status_kondisi"
                                                    ...
                                                    id="status_kondisi">
                                                    <option value="bagus" {{ old('status_kondisi') == 'bagus' ? 'selected' : '' }}>Bagus</option>
                                                    <option value="rusak" {{ old('status_kondisi') == 'rusak' ? 'selected' : '' }}>Rusak</option>
                                                    <option value="maintenance" {{ old('status_kondisi') == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                                                    <option value="tidak-lengkap" {{ old('status_kondisi') == 'tidak-lengkap' ? 'selected' : '' }}>Tidak Lengkap</option>
                                                    <option value="pengembangan" {{ old('status_kondisi') == 'pengembangan' ? 'selected' : '' }}>Pengembangan</option>
                                                    <option value="tidak-ditemukan" {{ old('status_kondisi') == 'tidak-ditemukan' ? 'selected' : '' }}>Tidak Ditemukan</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
