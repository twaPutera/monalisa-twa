...
$config = [
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), ['off', 'no'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
    ...
    */
    ...
    |
    */
    'thumbs_base_path' => '../../../../webconten-thumbnail/',
    ...
    */
    ...
    |--------------------------------------------------------------------------*/
    'ftp_thumbs_dir' => '../../webconten-thumbnail/',
    'ftp_ssl' => false,
    'ftp_port' => 21,
    ...
    */
    ...
    'access_keys' => [md5('goestoe_ari_2905')],
...
function getBaseUrl()
{
    ...
    return str_replace('images/', '', $protocol.$hostName.$pathInfo['dirname'].'/');
}
